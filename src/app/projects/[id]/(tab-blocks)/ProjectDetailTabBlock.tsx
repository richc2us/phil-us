...
export default function ProjectDetailTabBlock({id = ""}: {id: string}) {
    ...
    return(
                            ...
                            <div id="accordionBlock">
                                {
                                    blocks.map((block:any, index:any) => {
                                        return (
                                             <div className="rounded-t-lg border border-neutral-200 bg-white dark:border-neutral-600 dark:bg-body-dark" key={index}>
        ...
        {state.isEditingBlock && <ProjectDetailTabBlockUpdateBlock id={id}  refreshBlocks={() => { getBlocks() } }/>}
