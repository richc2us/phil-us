...
import { getReceiverAccountsAction } from "@/actions/receiver_accounts";
...
export default async function() {
  ...
  const documents = await getReceiverAccountsAction()
    return (
        <DefaultLayout>
              ...
              <div className="px-4 py-4 md:px-6 xl:px-7.5">
                  <div className="grid grid-cols-2">
                      ...
                      <div className="flex justify-end gap-4.5">
                          <Link href="/payments/receiver-account/new" className="flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base">
                          <button
                              className="flex justify-center rounded bg-primary px-6 py-1 font-medium text-gray hover:bg-opacity-90"
                              type="submit"
                              >
                              New Received Account
                          </button>
                          </Link>
                      </div>
                  </div>
              ...
              {documents.map((document:any, key:any) => (
                ...
                >
                  ...
                  <div className="col-span-1 flex items-center">
                    ...
                    <Link key={document._id} href={"/payments/receiver-account/" + document._id} className="mx-2" >
                      <button
