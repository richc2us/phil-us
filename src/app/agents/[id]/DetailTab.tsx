                    ...
                    <div className="flex flex-col gap-5.5 p-6.5">
                        ...
                        <div className="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
                            ...
                            <div className="w-full sm:w-1/3 flex gap-2">
                                    ...
                                    <div className="w-full sm:w-1/2">
                                        <InputTextLabel id="tin_issuance">
                        ...
                        <div className="w-full sm:w-1/3">
                                    <InputTextLabel id="civil_status">
                                        Civil Status
                                    </InputTextLabel>
                            ...
                            <div className="w-full sm:w-1/4">
                                        ...
                                        <InputSelectField
                                            ...
                                            icon={<SvgRealty/>}
                                            className={`disabled:cursor-default disabled:bg-whiter relative z-20 w-full appearance-none rounded border border-stroke bg-transparent px-12 py-3 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input ${ form.realty_id > 0 ? "text-black  dark:text-white" : "" }`}
                                        >
                                            ...
                                            </option>
                                            {
                                                form.realties && form.realties.map( (realty:any, key:any) =>
                                                    <option value={realty._id} className="text-body dark:text-bodydark" key={key}>
                                                        {realty.name}
                                                    </option>
                                                )
                                            }
