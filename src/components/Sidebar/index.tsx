...
import SvgRealty from "../common/svg/svg-realty";
import SvgAgent from "../common/svg/svg-agent";
import SvgTeamLead from "../common/svg/svg-teamlead";
import SvgDashboard from "../common/svg/svg-dashboard";
